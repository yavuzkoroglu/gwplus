...
ALL_COVERAGES="vertex edge edgepair edgetriple"
#ALL_COVERAGES="prime1"
#ALL_COVERAGES="prime2"
    ...
    do
        ...
        do
            ...
            do
                ...
                do
                    bin/gwplus -i ${EXPS}/${model}/m.json -c ${coverage} -m ${EXPS}/${model}/generated/gwplus_${method}_${targetcoverage}_${ratio}*.txt > ${EXPS}/${model}/coverages/gwplus_${method}_${targetcoverage}_${ratio}_${coverage}.txt
                    echo "bin/gwplus -i ${EXPS}/${model}/m.json -c ${coverage} -m ${EXPS}/${model}/generated/gwplus_${method}_${targetcoverage}_${ratio}*.txt > ${EXPS}/${model}/coverages/gwplus_${method}_${targetcoverage}_${ratio}_${coverage}.txt"
                done
            done
        done
    done
