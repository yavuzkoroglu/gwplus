    ...
    do
        ...
        do
            ...
            do
                ...
                echo "java -jar graphwalker-cli-4.3.2.jar offline -o -m \"${EXPS}/${model}/generated/gwplus_${method}_${coverage}_${ratio}.json\" \"predefined_path(predefined_path)\" | jq -r '.currentElementID' > ${EXPS}/${model}/generated/gwplus_${method}_${coverage}_${ratio}.txt"
                java -jar graphwalker-cli-4.3.2.jar offline -o -m "${EXPS}/${model}/generated/gwplus_${method}_${coverage}_${ratio}.json" "predefined_path(predefined_path)" | jq -r '.currentElementID' > ${EXPS}/${model}/generated/gwplus_${method}_${coverage}_${ratio}.txt
            done
        done
    done
